...
QT_TRANSLATE_NOOP("bitcoin-core", "Listen for JSON-RPC connections on <port> (default: 5252)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Listen for connections on <port> (default: 5253 or testnet: 15253)"),
