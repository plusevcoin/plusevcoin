...
// Copyright (c) 2014 The PlusEVCoin Devs
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    {
        nSubsidy = (50 - (nHeight * 0.00002)) * COIN; //Subsidy decreases by 0.00002 for next 2.45million blocks (~4.5 years)
    }
    else
    {
...
static const int64 nTargetSpacing = 60; // PlusEVCoin: 1 minute blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "R.I.P. Philip Seymour Hoffman";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
unsigned char pchMessageStart[4] = { 0xc2, 0xda, 0xf5, 0xeb };
